...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'GymManagementDB')
BEGIN
...
SET IDENTITY_INSERT Branch_Manager ON;

INSERT INTO Branch_Manager
(Branch_ID, Type, City, Area, Manager_ID, Manager_Fname, Manager_Lname, Manager_Phone)
VALUES
(1, 'Male', 'Cairo', 'Nasr City', 1, 'Ahmed', 'Ali', '01011111111'),
(2, 'Female', 'Giza', 'Dokki', 2, 'Sara', 'Omar', '01022222222'),
(3, 'Mixed', 'Alex', 'Smouha', 3, 'Mona', 'Hassan', '01033333333');

SET IDENTITY_INSERT Branch_Manager OFF;
DBCC CHECKIDENT ('Branch_Manager', RESEED, 3);
GO
...
INSERT INTO Equipment (Name, Purchase_Date, Maintainance_Duration, Branch_ID)
VALUES
('Treadmill', '2024-01-10', 90, 1),
('Yoga Mat', '2024-03-15', 180, 2),
('Barbell Set', '2023-11-20', 120, 3);
